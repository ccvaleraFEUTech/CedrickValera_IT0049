...
initNavigationEffects(); initCounterAnimations(); 
    initParallaxEffects(); 
    ...
    function initNavigationEffects() { 
        ...
        let lastScrollTop = 0;    window.addEventListener('scroll', function() { 
    ...
    function calculatePasswordStrength(password) { 
        ...
        if (/[^A-Za-z0-9]/.test(password)) strength++;     return strength; 
    } 
...
strengthLevels[0]}</small> 
    ...
    document.querySelectorAll('form').forEach(form => { 
        form.addEventListener('submit', function() { 
            ...
            if (submitBtn && !submitBtn.disabled) {      const originalText = submitBtn.innerHTML; 
